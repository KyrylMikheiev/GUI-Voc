...
public class TestSelection extends _BaseScreen {
    private boolean isCrossVisible1 = false; // Deklarieren Sie das JPanel als Klassenattribut
    private boolean isCrossVisible2 = false; // Deklarieren Sie das JPanel als Klassenattribut
    private boolean isCrossVisible3 = false; // Deklarieren Sie das JPanel als Klassenattribut
    private boolean isCrossVisible4 = false; // Deklarieren Sie das JPanel als Klassenattribut
    private boolean isCrossVisible5 = false; // Deklarieren Sie das JPanel als Klassenattribut
    ...
    public JPanel createUI() {
        ...
        selectedElements = new ArrayList<>(
                lessonRoster.getSelectedElementsAsStringList());
        ...
        // Jetzt, nachdem bodyPanel initialisiert wurde, kannst du die Hintergrundfarbe
        // setzen
        ...
        // Jetzt, nachdem buttonsPanel initialisiert wurde, kannst du die
        // Hintergrundfarbe setzen
        buttonsPanel.setBackground(ColorManager.bodyPrimary());

        JPanel buttonsPanel1 = new JPanel(new GridBagLayout());

        // Jetzt, nachdem buttonsPanel initialisiert wurde, kannst du die
        // Hintergrundfarbe setze
        buttonsPanel1.setBackground(ColorManager.bodyPrimary());
        ...
        checkBox1.setBackground(ColorManager.bodyPrimary());

        // Ändere die Schriftgröße, um die Größe der JCheckBox zu beeinflussen
        Font checkBoxFont1 = checkBox1.getFont();
        checkBox1.setFont(
                new Font(checkBoxFont1.getName(), checkBoxFont1.getStyle(), 20)); // 20 ist die gewünschte Schriftg
        checkBox1.setForeground(ColorManager.text());
        ...
        JCheckBox checkBox2 = new JCheckBox(
                "Reihenfolge der eingegebenen Übersetzungen ignorien");

        checkBox2.setPreferredSize(new Dimension(1000, 50));
        checkBox2.setBackground(ColorManager.bodyPrimary());

        // Ändere die Schriftgröße, um die Größe der JCheckBox zu beeinflussen
        Font checkBoxFont2 = checkBox2.getFont();
        checkBox2.setFont(
                new Font(checkBoxFont2.getName(), checkBoxFont2.getStyle(), 20)); // 20 ist die gewünschte Schriftg

        checkBox2.setForeground(ColorManager.text());
        ...
        checkBox3.setBackground(ColorManager.bodyPrimary());

        // Ändere die Schriftgröße, um die Größe der JCheckBox zu beeinflussen
        Font checkBoxFont3 = checkBox3.getFont();
        checkBox3.setFont(
                new Font(checkBoxFont3.getName(), checkBoxFont3.getStyle(), 20)); // 20 ist die gewünschte Schriftg

        checkBox3.setForeground(ColorManager.bodyPrimary());
        ...
        checkBox4.setBackground(ColorManager.bodyPrimary());

        // Ändere die Schriftgröße, um die Größe der JCheckBox zu beeinflussen
        Font checkBoxFont4 = checkBox4.getFont();
        checkBox4.setFont(
                new Font(checkBoxFont4.getName(), checkBoxFont4.getStyle(), 20)); // 20 ist die gewünschte Schriftg
        checkBox4.setForeground(ColorManager.text());
        ...
        JCheckBox checkBox5 = new JCheckBox("zufällige Konjugationen abfragen");
        checkBox5.setPreferredSize(new Dimension(1000, 50));
        checkBox5.setBackground((ColorManager.bodyPrimary()));

        Font checkBoxFont5 = checkBox5.getFont();
        checkBox5.setFont(
                new Font(checkBoxFont5.getName(), checkBoxFont5.getStyle(), 20)); // 20 ist die gewünschte Schriftgröße
        checkBox5.setForeground(ColorManager.text());

        checkBox5.addActionListener(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
        ...
        button6.setBackground(ColorManager.buttonDefault());
        button6.setForeground(ColorManager.text());
