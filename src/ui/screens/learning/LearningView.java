...
public class LearningView extends _BaseScreen {
    ...
    public LearningView(String lesson) {
        super(false);
    ...
    public LearningView(ArrayList<Integer> vocabs) {
        super(false);
        this.setKeepInHistory(false);
    ...
    private void initPanel() {
        ...
        bodyPanel_contentUp.setBackground(ColorManager.bodyPrimary());
        ...
        progress.setForeground(ColorManager.text());
        //end of progress
        ...
        lessonNumber.setForeground(ColorManager.text());
        //end of lessonNumber
        ...
        progressBar.setBorder(BorderFactory.createLineBorder(ColorManager.text(), 2));
        ...
        progressBar.setForeground(ColorManager.text());
        //end of progressBar
        ...
        backArrowLabel.setForeground(ColorManager.text());
        ...
        backArrowButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                backArrowButton.setBackground(ColorManager.buttonHover());
            }
        ...
        Image crossImage = new ImageIcon("./resources/images/close.png").getImage().getScaledInstance(App.getFrameSize()[0] / 5, App.getFrameSize()[0] / 5, Image.SCALE_SMOOTH);
        ...
        cross.addMouseListener(new MouseAdapter() {
                ...
                public void mouseEntered(MouseEvent e) {
                    ...
                    cross.setBackground(ColorManager.buttonHover());
                }
                @Override
                public void mouseExited(MouseEvent e) {
                    cross.setContentAreaFilled(false);
        ...
        phrase.setForeground(ColorManager.text());
        ...
        flashcard.setBackground(ColorManager.buttonDefault());
        flashcardPanel.add(flashcard, BorderLayout.CENTER);
        
        checkmarkPanel.setLayout(new BorderLayout());
        JButton checkmark = new JButton();
        Image checkmarkImage = new ImageIcon("./resources/images/checkmark.png").getImage().getScaledInstance(App.getFrameSize()[0] / 4, App.getFrameSize()[0] / 4, Image.SCALE_SMOOTH);
        ...
        checkmark.addMouseListener(new MouseAdapter() {
                ...
                public void mouseEntered(MouseEvent e) {
                    ...
                    checkmark.setBackground(ColorManager.buttonHover());
                }
                @Override
                public void mouseExited(MouseEvent e) {
                    checkmark.setContentAreaFilled(false);
        ...
        bodyPanel_contentDown.setBackground(ColorManager.bodyPrimary());
    ...
    private void showFinishedScreen() {
        ...
        congratulationScreen.setBackground(ColorManager.bodyPrimary());
        ...
        congratulations.setForeground(ColorManager.text());
        ...
        rightVocabsLabel.setForeground(ColorManager.text());
        ...
        wrongVocabsLabel.setForeground(ColorManager.text());
        ...
        backMainMenu.setBackground(ColorManager.buttonDefault());
        relearnVocabs.setBackground(ColorManager.buttonDefault());
        ...
        relearnVocabs.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                App.switchScreen(new LearningView(wrongVocabs));
            }
        });
        ...
        if (wrongVocabs.size() == 0) {
            ...
            noWrongVocabs.setForeground(ColorManager.text());
