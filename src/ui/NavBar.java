...
public class NavBar {
    ...
    private void initComponents() {
        ...
        navigationBar.setBackground(ColorManager.navbarBg());
        ...
        backButton.setBackground(ColorManager.navbarBg());
        ...
        appName.setForeground(ColorManager.navbarText());
        ...
        searchBar.setBorder(BorderFactory.createLineBorder(ColorManager.navbarText(), 2));
        ...
        textArea.setCaretColor(ColorManager.navbarText());
        textArea.setAlignmentY(JLabel.CENTER_ALIGNMENT);
        textArea.setForeground(ColorManager.navbarText());
        textArea.setBackground(ColorManager.navbarBg());
        textArea.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (active) {
                    App.switchScreen(new Search(textArea.getText()));
                }
            }
        });
        ...
        burgerMenu.setForeground(ColorManager.navbarText());
