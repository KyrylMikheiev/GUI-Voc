package de.vocabtrainer.ui.screens.settings;
...
import de.vocabtrainer.ui.Theme;

/**
 * Controller for {@code Settings.fxml}.
 *
 * <p>The dark-mode button calls Theme, which swaps the stylesheet on the
...
public class Settings extends Screen {
    ...
    private void onToggleDarkMode() {
        int newMode = Theme.getMode() == 1 ? 2 : 1;
    ...
    private void updateToggleIcon() {
        darkModeButton.setGraphic(Images.view(
                Theme.getMode() == 1 ? "Schieberegler_OFF.png" : "Schieberegler_ON.png",
                60, 30));
    }
